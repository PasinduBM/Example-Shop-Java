...
public class UpdateCustomerForm extends javax.swing.JFrame {
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        try {
            ...
            customerController.releaseCustomer(id);
    ...
    private void idTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_idTextActionPerformed
        ...
        try {
            CustomerController customerController = ServerConnector.getServerConnector().getCustomerController();
            customerController.releaseCustomer(this.id);
            this.id=id;
            Customer customer = customerController.searchCustomer(id);
            if (customer != null) {
                if(customerController.reserveCustomer(id)){
                    nameText.setText(customer.getName());
                    addressText.setText(customer.getAddress());
                    salaryText.setText(Double.toString(customer.getSalary()));
                }else{
                    JOptionPane.showMessageDialog(this, "Reserved customer "+id);
                }
            } else {
